...
<?php $this->view('bases/head'); ?>

<body>
<div class="wrapper">
  <div class="container">
    <?php $this->view('bases/navbar'); ?>
    <!-- /.navbar-collapse --> 
  </div>
  <!-- /.container-fluid -->
  ...
  <div class="main app form" id="main"><!-- Main Section-->
    ...
    <div class="app-features text-center" id="features">
      <div class="container">
        ...
        <div class="col-md-4 wow fadeInDown" data-wow-delay="0.5s"> <img class="img-responsive" src="assets/images/iPhone-app.png" alt="App" /> </div>
      ...
      <div class="container">
        <div class="col-md-10 col-md-offset-1">
          <div class="reviews owl-carousel owl-theme">
            ...
            <div class="review-single"><img class="img-circle" src="assets/images/customer2.png" alt="Client Testimonoal" />
            ...
            <div class="review-single"><img class="img-circle" src="assets/images/customer3.png" alt="Client Testimonoal" />
              <div class="review-text">
                <p>Morbi eget dictum enim. Praesent sed quam sit amet lorem tempor rhoncus. <br>
                  In hac habitasse platea dictumst. Vivamus in accumsan ex</p>
                <h3>- Alex Dattilo</h3>
            ...
            <div class="review-single"><img class="img-circle" src="assets/images/customer4.png" alt="Client Testimonoal" />
              <div class="review-text">
                <p>Morbi eget dictum enim. Praesent sed quam sit amet lorem tempor rhoncus. <br>
                  In hac habitasse platea dictumst. Vivamus in accumsan ex</p>
                <h3>- Robert Hammer</h3>
            ...
            <div class="review-single"><img class="img-circle" src="assets/images/customer5.png" alt="Client Testimonoal" />
              <div class="review-text">
                <p>Morbi eget dictum enim. Praesent sed quam sit amet lorem tempor rhoncus. <br>
                  In hac habitasse platea dictumst. Vivamus in accumsan ex</p>
...
<script src="assets/js/jquery.subscribe.js"></script>
</body>
</html>
